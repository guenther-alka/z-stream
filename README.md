...
Part of [napp-it cs web-gui](https://www.napp-it.org)” used by job-replicate for encrypted ZFS replication between members.
...
zfs send tank@snap | zstream send 192.168.1.10 9000 SESSIONKEY --rate=100m --progress --log=/tmp/zstream.log
```
...
- Session key per transfer (generated by job-replicate.pl) min length 8 char
